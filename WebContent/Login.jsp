...
<body class=" login">
 <div class="logo">
    ...
    <div class="content">
        <form action="UserController?userAction=7" class="form-login" method="post">            
		...
		<input name="__RequestVerificationToken" type="hidden" value="CfDJ8OvOdzIPtRJHhYr3p01t1ipaNyoILA6K6itZiiwzqOtOjnWAeiffZoiey6xWgU7NXwylgLG3e3NCrYXFkY3FAkyBTw2As7mEhOjQaUSClgAA8uxwWMker_qd4kyuwW9pM2B_dOQHdzQ7SPIuLYg30U8" /><input name="RemamberMe" type="hidden" value="false" />
	</form>   
 </div>
